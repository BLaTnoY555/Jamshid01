...
flush();
$API_KEY = '1068970788:AAEHgHlD5XAsOcHcXHWbmJvDnar5YMzhGYs';
##------------------------------##
...
$reply = $update->message->reply_to_message->message_id;
 $ADMIN = 956751252; //oddi asmin
 $ADMINS = 956751252; //gl admin idisi
 ...
 'parse_mode'=>'html',
            'reply_markup' =>  json_encode([
                'inline_keyboard' => [
                    ...
                    [['text' => "🔥Yangiliklar",'url'=>"https://telegram.me/Crontimes "]
                    ],
                    
                    [['text' => "👨💻 Admin",'url'=>"https://telegram.me/UzboTsMaster "]
                    ]
    ]
])
        ]);
...
[@Qorovul24Bot] - Guruh nazoratchi

[@Crontimes] - Ajoyib niklar yasash uchun

[@UzbotsMaster] - Kanalarga ♻Do’stlarni taklif qilish♻ postini qo’yish uchun

[@Crontimes] - Ob havo bilish uchun

[@Crontimes] - Hozircha ishlamaydi


*🔥Yangiliklar:* @Crontimes ",
                 'parse_mode'=>'makdown']);
}
if($text == "/kanal"){
...
Namuna </b> @Crontimes kanalini Crontimes <b> deb yuborasiz!</b>
...
🆔: @Crontimes ",
 'parse_mode'=>'html',
            'reply_markup' =>  json_encode([
                'inline_keyboard' => [
                    [
                        ['text' => "😂Qoshichi Kanalim🥀",'url'=>"https://telegram.me/Yebayt18"]
                    ],
                    [['text' => "😈Kanalimiz",'url'=>"https://telegram.me/Crontimes"]
                    ]
    ]
])
        ]);
